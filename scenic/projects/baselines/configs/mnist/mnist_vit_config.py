...
r"""Default configs for ViT on MNIST.
```
"""
# pylint: disable=line-too-long
...
def get_config(runlocal=''):
  """Returns the ViT experiment configuration for MNIST."""

  runlocal = bool(runlocal)

  config = ml_collections.ConfigDict()
  config.experiment_name = 'mnist-vit'
  # Dataset.
  ...
  # Learning rate.
  steps_per_epoch = _MNIST_TRAIN_SIZE // config.batch_size
